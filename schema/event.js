...
module.exports = Joi.object().keys({
  ...
  commit: Joi.string().regex(/^[a-f0-9]{32}$/).required().label('The commit SHA that the current build is testing'),
  ...
  pullRequestSha: Joi.string().regex(/^[a-f0-9]{32}$/).optional().label('The commit SHA of the HEAD commit of the PR'),
