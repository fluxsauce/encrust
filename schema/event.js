...
module.exports = Joi.object().keys({
  ...
  branch: Joi.string().token().allow(null).label('The name of the branch being built or targeted'),
  ...
  pullRequest: positiveInteger.allow(null).label('The pull request number'),
  pullRequestSha: sha.allow(null).label('The commit SHA of the HEAD commit of the PR'),
  pullRequestBranch: Joi.string().token().allow(null).label('The name of the branch from which the PR originated'),
