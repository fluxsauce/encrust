...
module.exports = Joi.object().keys({
  ...
  pullRequestSha: sha.default('').optional().label('The commit SHA of the HEAD commit of the PR'),
  pullRequestBranch: Joi.string().token().optional().label('The name of the branch from which the PR originated'),
